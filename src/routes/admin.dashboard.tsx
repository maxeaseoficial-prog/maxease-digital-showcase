  ...
  return (
    <div>
        ...
        {stats.map((s) => {
          ...
          return (
            <Link key={s.label} to={s.to}
              className="group rounded-2xl border border-slate-200/80 bg-white p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-[0_10px_30px_-18px_rgba(15,23,42,0.25)]">
      ...
      <div className="mt-8 grid lg:grid-cols-2 gap-4">
        <Link to="/admin/clientes" className="rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-[0_10px_30px_-18px_rgba(15,23,42,0.25)]">
        ...
        <Link to="/admin/site" className="rounded-2xl border border-slate-200/80 bg-white p-6 transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-[0_10px_30px_-18px_rgba(15,23,42,0.25)]">
